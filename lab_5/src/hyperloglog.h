...
#ifndef GRIDGRAPH_HYPERLOGLOG_H
#define GRIDGRAPH_HYPERLOGLOG_H
...
static double count_hll_counter(hyper_log_log_params *param,
                               unsigned char *counter)
{
    double s   = 0;
    double tmp = 0;
